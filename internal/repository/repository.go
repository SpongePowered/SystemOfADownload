...
// txRepository is a Repository within a transaction.
...
// WithTx for a transaction repository returns an error since nested transactions are not supported.
func (r *txRepository) WithTx(ctx context.Context, fn func(Repository) error) error {
	// Nested transactions not supported - just execute the function with this repository
	return fn(r)
}

// Delegate all Querier methods to the underlying querier
func (r *txRepository) CreateArtifact(ctx context.Context, arg db.CreateArtifactParams) (db.Artifact, error) {
	return r.q.CreateArtifact(ctx, arg)
}

func (r *txRepository) CreateArtifactVersion(ctx context.Context, arg db.CreateArtifactVersionParams) (db.ArtifactVersion, error) {
	return r.q.CreateArtifactVersion(ctx, arg)
}

func (r *txRepository) CreateArtifactVersionAsset(ctx context.Context, arg db.CreateArtifactVersionAssetParams) (db.ArtifactVersionedAsset, error) {
	return r.q.CreateArtifactVersionAsset(ctx, arg)
}

func (r *txRepository) CreateArtifactVersionTag(ctx context.Context, arg db.CreateArtifactVersionTagParams) (db.ArtifactVersionedTag, error) {
	return r.q.CreateArtifactVersionTag(ctx, arg)
}

func (r *txRepository) CreateGroup(ctx context.Context, arg db.CreateGroupParams) (db.Group, error) {
	return r.q.CreateGroup(ctx, arg)
}

func (r *txRepository) GetArtifactByGroupAndId(ctx context.Context, arg db.GetArtifactByGroupAndIdParams) (db.Artifact, error) {
	return r.q.GetArtifactByGroupAndId(ctx, arg)
}

func (r *txRepository) GetArtifactVersion(ctx context.Context, arg db.GetArtifactVersionParams) (db.ArtifactVersion, error) {
	return r.q.GetArtifactVersion(ctx, arg)
}

func (r *txRepository) GetGroup(ctx context.Context, mavenID string) (db.Group, error) {
	return r.q.GetGroup(ctx, mavenID)
}

func (r *txRepository) GroupExistsByMavenID(ctx context.Context, lower string) (bool, error) {
	return r.q.GroupExistsByMavenID(ctx, lower)
}

func (r *txRepository) ListArtifactVersionAssets(ctx context.Context, artifactVersionID int64) ([]db.ArtifactVersionedAsset, error) {
	return r.q.ListArtifactVersionAssets(ctx, artifactVersionID)
}

func (r *txRepository) ListArtifactVersionTags(ctx context.Context, artifactVersionID int64) ([]db.ArtifactVersionedTag, error) {
	return r.q.ListArtifactVersionTags(ctx, artifactVersionID)
}

func (r *txRepository) ListArtifactVersions(ctx context.Context, arg db.ListArtifactVersionsParams) ([]db.ArtifactVersion, error) {
	return r.q.ListArtifactVersions(ctx, arg)
}

func (r *txRepository) ListArtifactsByGroup(ctx context.Context, groupID string) ([]db.Artifact, error) {
	return r.q.ListArtifactsByGroup(ctx, groupID)
}

func (r *txRepository) ListGroups(ctx context.Context) ([]db.Group, error) {
	return r.q.ListGroups(ctx)
}

func (r *txRepository) UpdateArtifactVersionOrder(ctx context.Context, arg db.UpdateArtifactVersionOrderParams) error {
	return r.q.UpdateArtifactVersionOrder(ctx, arg)
}
